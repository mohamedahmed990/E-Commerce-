...
export default function NavbarComponent() {
  ...
  return (
    <>
      <Navbar className={Style["bg-navbar"]} expand="lg" sticky="true">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            {token ? <Nav className="me-auto gap-5">
              <NavLink activeclassname={Style.active} className="text-decoration-none text-dark secondary-text-color" to="/products" href="/products">Products</NavLink>
